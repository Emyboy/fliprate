                    ...
                    <div className='col-xl-6 col-lg-6'>
                        <div className='pq-section pq-style-1 text-left'>
                            ...
                            <p className='pq-section-description'>
                                Fliprate technologies is a leading solutions
                                provider in the crypto currency space, working
                                with companies leveraging blockchain technology
                                to facilitate currency flows across borders.
                                With blockchain, payments are set to be low –
                                cost secure and processed quickly. Our Services
                                include
                            </p>
                        </div>
                        <ul className='pq-list-check mb-4'>
                            <li className='pq-list-item'>
                                <a href='#'>
                                    ...
                                    <span>
                                        Build web3 technology. Our team of
                                        engineers and developers are positioned
                                        to help you build web3 solutions,
                                        ensuring your technology is seamless,
                                        safe and secure.
                                    </span>
                                </a>
                            </li>
                            <li className='pq-list-item'>
                                <a href='#'>
                                    <i className='ion ion-android-done-all'></i>
                                    <span>
                                        Supply of Bulk crypto currency. We
                                        provide large amounts of crypto currency
                                        to payment companies, assisting their
                                        capacity to deliver settlements to their
                            ...
                            <li className='pq-list-item'>
                                <a href='#'>
                                    <i className='ion ion-android-done-all'></i>
                                    <span>
                                        Provide Advisory services / a think tank
                                        designed to engage web3 organizations as
