            ...
            <div className="row align-items-center">
                <div className="col-xl-6 col-lg-6">
                    <div className="pq-section pq-style-1 text-left">
                        ...
                        <h5 className="pq-section-title added" id="technology" data-high_text="Technology" data-title_text="We Increasing Business Success With Technology" data-rough_color="#fd4a18" data-rough_type="underline"> Increasing  Business  Success  With <span className="last-word"> Technology </span>
                        ...
                        <p className="pq-section-description">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable.</p>
                    </div>
                ...
                <div className="col-xl-6 col-lg-6 mt-4 mt-lg-0">
                    <div className="about-us-img">
                        <img src="/assets/images/about-us/4.jpg" className="pq-image6  wow zoomIn animated" alt="" />
                        <img src="/assets/images/about-us/5.jpg" className="pq-image7  wow fadeInLeft animated" alt="" />
                    </div>
                </div>
            </div>
        </div>
