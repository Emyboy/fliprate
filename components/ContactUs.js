                    ...
                    <div className='col-lg-6 col-md-12 mt-4 mt-lg-0'>
                        <div className='inquiry-form pq-bg-grey'>
                            <div className='pq-form-section pq-style-1 text-center'>
                                <span className='pq-form-sub-title'>
                                    # help you 24/7
                                </span>
                                <h5 className='pq-form-title'>
                                    React Out To Us
                                </h5>
                            </div>
                                ...
                                <div className='row gap-3'>
                                    <div className='col-md-12'>
                                        <input
                                            type='text'
                                            id='first-name'
                                            className='pq-bg-white name-field px-2 border-none rounded-[5px] '
                                            placeholder='Name'
                                            required
                                        />
                                    </div>
                                    <div className='col-md-12'>
                                        <input
                                            type='text'
                                            id='e-mail'
                                            className='pq-bg-white e-mail-field border-none rounded-[5px]'
                                            placeholder='Email'
                                            required
                                        />
                                    </div>
                                    ...
                                    <div className='col-md-12'>
                                        <select
                                            className='pq-bg-white e-mail-field mb-3 px-2 border-none rounded-[5px]'
                                            style={{
                                                borderColor: "#e9ecef",
                                                color: "#6c757d",
                                            }}
                                        >
                                            ...
                                            <option>
                                                Build web3 technology
                                            </option>
                                            <option>
                                                Supply of Bulk crypto currency
                                            </option>
                                            <option>
                                    ...
                                    <div className='col-md-12'>
                                        <textarea
                                            name='your-message'
                                            id='message'
                                            className='pq-bg-white px-2 border-none rounded-[5px]'
                                            cols='10'
                                            rows='4'
